...
<%@page language="java" import="model.postRole.*" %>  
<%@page language="java" import="view.PostRoleView" %> 
...
<%
    ...
    if (list.dbError.length() == 0) { // if got good DB connection,
        ...
        System.out.println("*** Ready to call allPostsAPI");
        list = PostRoleView.getAllRoles(dbc);   
    } 
